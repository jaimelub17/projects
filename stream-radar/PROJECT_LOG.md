...
## Step 7 — Moved into the portfolio umbrella (2026-08-28)

**Goal:** one resume hub. The project now lives at `github.com/jaimelub17/projects/tree/main/stream-radar`, beside corporate-scorecard, per the portfolio pattern.
